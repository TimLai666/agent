...
def set_runtime_paths(
	*,
	...
	global TIM_AGENT_ROOT, TIM_AGENT_CONFIG_DIR, TIM_AGENT_SKILLS_DIR, TIM_AGENT_SANDBOX_DIR
	global _RUNTIME_PATH_OVERRIDDEN

	if any(value is not None for value in (root, config_dir, skills_dir, sandbox_dir)):
