...
description: V2 instructions for generating prompt suggestions for ${SYSTEM_NAME}
ccVersion: 2.0.73
-->
[SUGGESTION MODE: Suggest what the user might naturally type next into ${SYSTEM_NAME}.]
